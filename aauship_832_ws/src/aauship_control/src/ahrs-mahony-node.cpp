...
//#include <aauship_control/MadgwickAHRS.h>
...
public:
  ...
  void adisCallback(const aauship_control::ADIS16405::ConstPtr& msg)
  {
    /* AHRS update */
    u.MahonyAHRSupdate(
  ...
  void ahrscfgCallback(const aauship_control::ADIS16405::ConstPtr& msg)
  {
